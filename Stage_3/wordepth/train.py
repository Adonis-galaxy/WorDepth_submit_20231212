# --checkpoint_path_stage_3 /media/home/zyzeng/code/wordepth/WorDepth_KITTI/Stage_3/models/1116_0_kitti_stage_3_con/model-172500-best_rms_2.16728
import torch
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    print("Start Training Sucessfully!")
    ...
    # Training parameters
    optimizer = torch.optim.Adam([{'params': model.module.parameters()},{'params': model_1.module.parameters()},{'params': model_2.module.parameters()}],
    ...
    while epoch < args.num_epochs:
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            eps=model_2(image_feature_list)
            inter_feature, prior_depth = model_1(image, gts=depth_gt, text_feature=text_feature_list,eps=eps)

            # ====== Stage 3 inference ======
            depth_est, loss = model(image=image, gts=depth_gt, inter_feature=inter_feature,prior_depth=prior_depth)
            ...
            if Training_Success==False:
                ...
                print("Start Training Sucessfully-1!")
            ...
            if global_step % args.log_freq==0:
                ...
                # eval_summary_writer.add_scalar("Smooth Loss", loss_smooth.item(), int(global_step))
                ...
                if eval_measures is not None:
                    for i in range(9):
                        ...
                        if is_best:
                            ...
                            torch.save(model_1.state_dict(), args.log_directory + '/' + args.model_name + model_save_name+"stage_1")
                            torch.save(model_2.state_dict(), args.log_directory + '/' + args.model_name + model_save_name+"stage_2")
...
def main():
    ...
    os.system(command)
    os.system('cp ' + "wordepth/train.py" + ' ' + args_out_path + "/train.py.backup")
    os.system('cp ' + "wordepth/networks/stage_1_2.py" + ' ' + args_out_path + "/stage_1_2.py.backup")
    os.system('cp ' + "wordepth/networks/stage_3.py" + ' ' + args_out_path + "/stage_3.py.backup")
    os.system('cp ' + "wordepth/networks/loss.py" + ' ' + args_out_path + "/loss.py.backup")
