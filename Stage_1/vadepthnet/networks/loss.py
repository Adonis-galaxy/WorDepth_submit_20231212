...
class VD_Loss(nn.Module):
    ...
    def forward(self, depth_prediction, reshaped_gt, image):
        ...
        # num_pixels = (reshaped_gt > 1e-3) * (reshaped_gt < self.max_depth)
        ...
        # )# return diff if meet first row condition, otherwise return 0 (non-grad)

        
        # loss_depth = loss_depth.reshape(loss_depth.shape[0], -1)
